...
def main():
    ...
    valPredsDataFrame = pd.read_csv(os.path.join(CSV_LOC, 'my_val.csv'))
    ...
    for idx in range(len(valPredsDataFrame)):
        predBoxes = Utils.getPredBoxes(valPredsDataFrame, idx)
    ...
    idx = 850  # change this to TDV other frames
